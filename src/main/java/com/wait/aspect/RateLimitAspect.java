...
public class RateLimitAspect {
    ...
    private final SpelExpressionParserUtil spelExpressionParserUtil;
    ...
    // 使用 proceed() 方法调用原始方法时，因无法预知原始方法运行过程中是否会出现异常，强制抛出 Throwable
    // 对象，封装原始方法中可能出现的异常信息
    ...
    private String handleRateLimited(ProceedingJoinPoint joinPoint, RateLimit rateLimit, String key) {
        ...
        log.warn("Request rate limited: key = {}, limit = {} / {} {}, method = {}",
